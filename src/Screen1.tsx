...
const DriverScreen = ({ route, navigation }: { route: any; navigation: any }) => {
      ...
      socket.emit(
        ...
        async (response: any) => {
          ...
          if (response && response.success) {
            ...
            // Show rider details automatically when ride is accepted
            showRiderDetails();
  ...
  return (
    <View style={styles.container}>
      ...
      {/* IMPROVED: Passenger Data Card - Positioned higher to avoid overlapping with OTP button */}
      {ride && userData && rideStatus === "accepted" && (
        <View style={styles.passengerCardContainer}>
          <View style={styles.passengerCard}>
            <View style={styles.passengerHeader}>
              ...
              <View style={styles.passengerInfo}>
                <Text style={styles.passengerName}>{userData.name}</Text>
                <View style={styles.ratingContainer}>
                  <MaterialIcons name="star" size={16} color="#FFD700" />
                  <Text style={styles.ratingText}>{userData.rating}</Text>
                </View>
              </View>
              <TouchableOpacity onPress={toggleRiderDetails} style={styles.expandButton}>
            ...
            <View style={styles.passengerDetails}>
              <View style={styles.passengerDetailRow}>
                ...
                <Text style={styles.passengerDetailText}>{userData.mobile}</Text>
                <TouchableOpacity onPress={handleCallPassenger} style={styles.passengerActionIcon}>
              ...
              <View style={styles.passengerDetailRow}>
                ...
                <Text style={styles.passengerDetailText} numberOfLines={1}>
                  {ride.pickup.address}
                </Text>
              </View>
            ...
            <View style={styles.passengerFare}>
      ...
      {/* Enhanced Rider Details - Only shown when expanded */}
      {riderDetailsVisible && ride && userData && (
        ...
        >
          <View style={styles.riderDetailsHeader}>
            ...
            <TouchableOpacity onPress={hideRiderDetails} style={styles.closeButton}>
      ...
      {ride && userData && !riderDetailsVisible && rideStatus !== "accepted" && (
...
const styles = StyleSheet.create({
  ...
  onlineToggleContainer: {
    position: "absolute",
    top: 120, // Moved to bottom
    right: 37, // Moved to right
  ...
  onlineToggleButton: {
    ...
    shadowOpacity: 0.2,
    shadowRadius: 6,
    minWidth: 350, // Ensure consistent width
  },
  onlineButton: {
  ...
  // NEW: Improved Passenger Card Styles
  passengerCardContainer: {
    position: "absolute",
    bottom: 120, // Positioned higher to avoid overlapping with OTP button
    left: 16,
    right: 16,
    zIndex: 5,
  },
